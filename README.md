...
- [Prof. Jimmy Lin](https://cs.uwaterloo.ca/~jimmylin/) / [Castorini](https://github.com/castorini)
- [Don't Mess with the Don](https://github.com/uwblueprint/dont-mess-with-the-don)
- Rebuilding a local restaurant's ordering stack in Next.js, React, and TypeScript
- [Qube](https://github.com/Evan-Lowry/Qube), a GAN Bluetooth speedcube timer for iPhone, iPad,and Mac
